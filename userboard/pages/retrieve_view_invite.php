...
<?php
  ...
  $sql = 'SELECT * FROM invites where Rec_ID="'.$_SESSION['user'].'"';
  ...
  while($row = mysqli_fetch_array($query))
  {
	...
	$EmailIDval=$row['Send_ID'];
	$sql2='SELECT Username FROM users where EmailID="'.$EmailIDval.'"';
